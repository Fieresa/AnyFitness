...
<td>
<input type="number" name="Id_reservation" value="Id_reservation will be automaticly set" disabled></td>
</tr>
<tr>
<td>Id_cour</td>
<td><input type="text" name="Id_cour" value="<?PHP echo $_GET['Id_cour'] ?>" readonly></td>
</tr>
<tr>
<td>Id_client</td>
<td><input type="text" name="Id_client" value="<?PHP echo $_SESSION['userid'] ?>" readonly></td>
</tr>
<tr>
<td></td>
