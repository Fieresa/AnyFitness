...
<tr>
<td>Id_coach</td>
<td><input type="number" name="Id_coach" placeholder="Id_coach" max="99"  class="form-control"></td>
</tr>
<tr>
<td>Nom</td>
<td>
...
<input  type="text" name="nom" onblur="calculeLongueur();" onfocus="calculeLongueur();" onkeydown="calculeLongueur();" onkeyup="calculeLongueur();"  id="autre" class="form-control"  required pattern="[0-9a-zA-Z,/. ]{3,16}" placeholder="Nom"></input>
              
</div>
</tr>
<tr>
<td>Prenom</td>
<td><input type="text" name="prenom" placeholder="Prenom" maxlength="16"  class="form-control"></td>
</tr>
<tr>
<td>Path</td>
<td><input type="file" name="Path" value="images.png"  class="form-control" accept="image/png , image/jpeg"></td>
</tr>
<tr>
<td></td>
