      ...
      <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-6 col-xs-12 mb-1">
            <h2 class="content-header-title">Administrateur</h2>
          </div>
...
<div class="card">
    <div class="card-header">
        <h4 id="basic-forms" class="card-title">Bienvenue Mr l'Admin</h4>
    ...
    <div class="card-body collapse in" aria-expanded="true">
      ...
      <p class="card-text">Ces interfaces vous offre la possibilité de consulter la liste des commandes ainsi que les supprimer les trier ou bien faire une recherche avancée sur cette table comme vous pouvez aussi chercher la liste des commandes d'un client donné par son identifiant et voir les commandes payees et non payees.
      Nous vous donnons aussi le droit de consulter la liste des codes ainsi que les ajouter les supprimer les trier ou bien faire une recherche avancée sur cette table comme vous pouvez aussi chercher la liste des codes donné par leur montant et voir les codes utilises et non utilises.
      Comme vous pouvez aussi consulter les statistiques en forme de charts pour voir les produits les plus commandes ou les montants des codes les plus utilises ou voir les pourcentages des commandes payees et non payees ainsi que leurs prix totals et les pourcentages des codes utilises et non utilises ainsi que leurs valeurs totales ou bien consulter les tops acheteurs ou le client du mois en notant que le client du mois resevera un code de recharge gratuit a la fin de ce dernier.        </div>
    </div>
</div>
        </div>
      </div>
