...
function initMap() {
  ...
  var uluru = {lat: 36.8374946, lng: 10.1927389};
  ...
  var marker = new google.maps.Marker({position: uluru, map: map});
    ...
    <script async defer
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAMRGiKOTErT4nb4XlEBlITjeoOTOg3noc&callback=initMap">
    </script>
				...
				<div class="row">
				<a class="twitter-timeline" href="https://twitter.com/FieresaEsports?ref_src=twsrc%5Etfw">Tweets by Firas</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
				</div>
			</div>
		</div>
		...
		<div id="colorlib-schedule" class="colorlib-light-grey">
			<div class="container">
					<div class="row">
					<div class="fb-page" data-href="https://web.facebook.com/Fitness.Fitness.Laouina/" data-tabs="timeline" data-width="" data-height="" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://web.facebook.com/Fitness.Fitness.Laouina/" class="fb-xfbml-parse-ignore"><a href="https://web.facebook.com/Fitness.Fitness.Laouina/">Any Fitness : L&#039;Aouina</a></blockquote></div>
				</div>
				</div>
			</div>
