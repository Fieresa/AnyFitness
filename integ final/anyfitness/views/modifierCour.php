...
<tr>
<td>Id_cour</td>
<td><input type="text" name="Id_cour" value="<?PHP echo $Id_cour ?>" class="form-control" readonly></td>
</tr>
<tr>
<td>Id_coach</td>
<?php
...
<td>        <select name="Id_coach" class="form-control">
        <?php echo $options;?> 
        </select>
</td>
</tr>
...
<td>        <select name="Id_backupcoach" class="form-control">
        <?php echo $options;?> 
        </select>
</td>
</tr>
...
<script language="javascript" type="text/javascript">
                  function calculeLongueur(){
                      ...
                      if (iLongueur>10) {
                        document.getElementById('autre').value = document.getElementById('autre').value.substring(0,36);
                        iLongueurRestante = 0;
                      }
                      else {
                      iLongueurRestante = 36 - iLongueur;
                    }
...
<input  type="text" name="Capacity" onblur="calculeLongueur();" onfocus="calculeLongueur();" onkeydown="calculeLongueur();" onkeyup="calculeLongueur();"  id="autre" class="form-control"  required pattern="[0-9a-zA-Z,/. ]{3,16}" placeholder="Nom" value="<?php  echo $Capacity; ?>"></input>
              
<tr>
<td>Duration</td>
<td><input type="number" name="Duration" value="<?PHP echo $Duration ?>" min="15" max="120" class="form-control"></td>
</tr>
<td>Heure</td>
<td><input type="time" name="Heure" value="<?PHP echo $Heure ?>" min="08:00" max="22:00" class="form-control"></td>
</tr>
<tr>
<td>Jour</td>
<?php
...
<td>        <select name="Jour" class="form-control">
        <?php echo $options;?> 
        </select>
</td>
</tr>
...
?>
<meta http-equiv="Refresh" content="0;URL=afficherbackcour.php">
<?php
}
?>
