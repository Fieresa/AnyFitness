...
<div class="card">
    <div class="card-header">
        <h4 id="basic-forms" class="card-title">Ajouter categorie</h4>
    ...
    <div class="card-body collapse in" aria-expanded="true">
        <div class="card-block">
              ...
              <form method="POST" action="ajoutCategorie.php">
                                <div class="form-group"><label for="NoC" class=" form-control-label">NoC</label><input type="number" name="NoC" placeholder="1234567890" class="form-control" required ></div>
                                    <div class="form-group"><label for="NomC" class=" form-control-label">NomC</label><input type="text" name="NomC" placeholder="Enter your Categories name" class="form-control" required ></div>
                                        <div class="form-group"><label for="DescriptionC" class=" form-control-label">DescriptionC</label><input type="text" name="DescriptionC" placeholder="Enter your description" class="form-control" required   onblur="calculeLongueur();" onfocus="calculeLongueur();" onkeydown="calculeLongueur();" onkeyup="calculeLongueur();"  id="autre"></div>
