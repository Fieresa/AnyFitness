      ...
      <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-6 col-xs-12 mb-1">
            <h2 class="content-header-title">Affichage des reclamation</h2>
          </div>
...
<div class="card">
    <div class="card-header">
        <h4 id="basic-forms" class="card-title">Reclamations</h4>
...
if(isset($_POST['tri']))
{$listeReclamations=$reclamation1C->tri();}

//var_dump($listeReclamations->fetchAll());

?>
<form method="POST" action="afficherbackReclamation.php">
<input name="tri" type="submit" value="Tri par type">
</form>
<form method="POST" action="fpdfcreatepdf/PDF_reclamation.php">
...
foreach($listeReclamations as $row){
  ?>
      ...
      <td>
        <form method="POST" action="supprimerbackReclamation.php">
          <input type="submit" name="supprimer" value="supprimer">
          <input type="hidden" value="<?PHP echo $row['id'] ?>" name="id">
        </form>
      </td>
      <td>
        <a href="modifierbackReclamation.php?id=<?PHP echo $row['id'] ?>">Modifier</a>
      </td>
    </tr>  
  <?PHP
}
