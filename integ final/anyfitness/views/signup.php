			   			...
			   			<div class="row">
				   			<div class="col-md-6 col-sm-12 col-md-offset-3 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h1>Account</h1>
				   					<h2><span><a href="#">Home</a> | Account Sign up</span></h2>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
						...
						<form method="POST" action="ajoutUser.php">
							...
							<div class="row form-group">
								<div class="col-md-6">
									...
									<input type="text" id="fname" maxlength="15" class="form-control" placeholder="Your firstname" name="prenom" required>
								</div>
								<div class="col-md-6">
									<!-- <label for="lname">Last Name</label> -->
									<input type="text" id="lname" maxlength="15" class="form-control" placeholder="Your lastname" name="nom" required>
								</div>
							</div>
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									<input type="email" id="email" maxlength="40" class="form-control" placeholder="Your email address" name="email" required>
								</div>
							</div>
