...
<div class="card">
    <div class="card-header">
        <h4 id="basic-forms" class="card-title">Reservations</h4>
...
<td><input type="number" name="Id_reservation"  min="0" max="99999" class="form-control" value="<?PHP echo $Id_reservation ?>" readonly></td>
</tr>
<tr>
  <td>Id_cour</td>
<?php
...
<td>        <select name="Id_cour" class="form-control" value="<?PHP echo $Id_cour ?>">
        <?php echo $options;?> 
        </select>
</td>
</tr>
...
?>
<td>        <select name="Id_client" class="form-control" value="<?PHP echo $Id_client ?>">
        <?php echo $options;?> 
        </select>
</td>
</tr>
...
?>
<meta http-equiv="Refresh" content="0;URL=afficherbackreservation.php">
<?php
}
?>
</body>
