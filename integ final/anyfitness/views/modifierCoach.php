...
<tr>
<td>Id_coach</td>
<td><input type="number" name="Id_coach" value="<?PHP echo $Id_coach ?>" placeholder="Id_coach" max="99"  class="form-control" readonly></td>
</tr>
<tr>
<td>Nom</td>
<td>
<div>
  ...
  <input type="text" name="nom" value="<?PHP echo $nom ?>" onblur="calculeLongueur();" onfocus="calculeLongueur();" onkeydown="calculeLongueur();" onkeyup="calculeLongueur();"  id="autre" class="form-control"  required pattern="[0-9a-zA-Z,/. ]{3,16}" placeholder="Nom"></td>
</div>
</tr>
<tr>
<td>Prenom</td>
<td><input type="text" name="prenom" value="<?PHP echo $prenom ?>" placeholder="Prenom" maxlength="16"  class="form-control"></td>
</tr>
<tr>
<td>Path</td>
<td><input type="file" name="Path" value="<?PHP echo $Path ?>" class="form-control" accept="image/png , image/jpeg"></td>
</tr>
<tr>
<td></td>
...
if (isset($_POST['modifier'])){
  $coach=new coach($_POST['Id_coach'],$_POST['nom'],$_POST['prenom'],$_POST['Path']);
  $coachC->modifiercoach($coach,$_POST['Id_coach_ini']);
  echo $_POST['Id_coach_ini'];
  ?>
  <meta http-equiv="Refresh" content="0;URL=afficherbackcoach.php">
  <?php
}
?>
