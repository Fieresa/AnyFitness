      ...
      <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-6 col-xs-12 mb-1">
            <h2 class="content-header-title">Display category</h2>
          </div>
...
<div class="card">
    <div class="card-header">
        <h4 id="basic-forms" class="card-title">Category</h4>
...
foreach($listeCategories as $row){
  ...
  <td><a class="button"  href="editback.php?userid=<?PHP echo $row['userid']; ?>">
  Edit</a></td>
  </tr>
  <?PHP
}
