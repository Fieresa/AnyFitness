...
<div class="card">
    ...
    <div class="card-body collapse in" aria-expanded="true">
      ...
      <form method="POST" action="ajoutcour.php">
<table>
<tr>
<td>Id_cour</td>
<td><input type="text" name="Id_cour" min="1" max="999" class="form-control"></td>
</tr>
<tr>
<td>Id_coach</td>
<?php
...
<input  type="text" name="Capacity" onblur="calculeLongueur();" onfocus="calculeLongueur();" onkeydown="calculeLongueur();" onkeyup="calculeLongueur();"  id="autre" class="form-control"  required pattern="[0-9a-zA-Z,/. ]{3,16}" placeholder="Nom"></input>
              
</div>
</tr>
<tr>
<td>Duration /m</td>
<td><input type="number" name="Duration" min="15" max="120" class="form-control"></td>
</tr>
<td>Heure /h</td>
<td><input type="time" name="Heure" min="08:00" max="22:00" class="form-control"></td>
</tr>
<tr>
<td>Jour</td>
<?php
