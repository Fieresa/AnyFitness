						...
						<form method="POST" action="verification.php">
							<div class="row form-group">
								<div class="col-md-12">
									...
									<input type="number" id="email" class="form-control" placeholder="Your UserId" name="userid" required>
								</div>
							</div>
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									<input type="password" id="subject" class="form-control" placeholder="Password" name="password" required>
								</div>
							</div>
					...
					<div class="col-md-3 colorlib-widget">
						...
						<p>
							<ul class="colorlib-footer-links">
								...
								<li><a href="#"><i class="icon-check"></i> Account Mangement</a></li>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Sidkom Firas</a>
