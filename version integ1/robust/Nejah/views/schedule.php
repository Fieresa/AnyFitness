...
<li class="has-dropdown">
								...
								<li><a href="../../ProjetWeb/Frontend/views/disconnect.php?deconnexion=true">Disconnect</a></li>
																...
																<li><a href="../../views/affichercodes.php">Codes</a></li>
								<li class="btn-cta"><a href="../../views/panier.php"><span><i class="icon-cart"></i></span></a></li>
							</ul>
						</div>
					</div>
				</div>
			   			...
			   			<div class="row">
				   			<div class="col-md-6 col-sm-12 col-md-offset-3 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h1>Schedule</h1>
				   					<h2><span><a href="../../ProjetWeb/Frontend/views/Home.php">Home</a> | Schedule | <a href="affichereservation.php">Check Reservations</a></span></h2>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center colorlib-heading animate-box">
						...
						<p>We have all kinds of classes for all ages and preferences check them out ...</p>
						<p><span><a href="schedulebase.html">More Info</a></p>
					</div>
				</div>
				<div class="row">
