...
$listecommandes=$commandesc1->afficherhiscommandes($_SESSION['userid']);
?>
<!DOCTYPE HTML>
<html>
  <head>
              ...
              <div class="row">
                <div class="col-md-6 col-sm-12 col-md-offset-3 slider-text">
                  <div class="slider-text-inner text-center">
                              <h1>Recherche avancée des commandes</h1>
...
<h2 align="center">Veuillez taper le text a chercher</h2>
