...
$codec1=new codec();
$listecodes=$codec1->affichercodep($_SESSION['userid']);
			...
			<div class="top-menu">
				<div class="container">
					...
					<div class="col-md-10 text-right menu-1">
							<ul>
								<li><a href="../ProjetWeb/Frontend/views/Home.php">Home</a></li>
								<li><a href="../Nejah/views/about.php">Trainers</a></li>
								<li><a href="../Nejah/views/schedule.php">Schedule</a></li>
								<li><a href="../front_falleg/about.php">Products</a></li>
								<li><a href="event.html">Events</a></li>
<li class="has-dropdown">
								<a href="../ProjetWeb/Frontend/views/edit.php?userid=<?PHP echo $_SESSION['userid']; ?>">Account Management</a>
								<ul class="dropdown">
								<li><a href="../ProjetWeb/Frontend/views/disconnect.php?deconnexion=true">Disconnect</a></li>
								</ul>
								</li>
																<li class="active"><a href="affichercodes.php">Codes</a></li>
			   			...
			   			<div class="row">
				   			<div class="col-md-6 col-sm-12 col-md-offset-3 slider-text">
				   				<div class="slider-text-inner text-center">
				   										   					<h1>Codes utilisés</h1>
				   										<h2><span><a href="../ProjetWeb/Frontend/views/Home.php">Home</a> | Codes</span></h2>
...
<!--				   					<h2><span><a href="index.html">Home</a> | Blog</span></h2> -->
		...
		<div class="colorlib-blog">
					   					...
					   					<table border="1" width="50%" id="tablepanier" align="center">
<tr>
<td>num</td>
<td>montant</td>
</tr>
...
<form method="POST" action="utilisercode.php" align="center">
