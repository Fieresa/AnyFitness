...
<td>Votre solde apres payement: </td>
<?php
foreach($soldenouv as $row){
	?>
	<tr>
<td><?PHP echo $row['sn']; ?> DT</td>
</tr>
<?php
}
...
<form method="POST" action="payement.php">
	<input type="submit" name="Confirmer" value="Confirmer" onclick="window.open('../pdf/createpdf.php');">
	</form>
