      ...
      <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-6 col-xs-12 mb-1">
            <h2 class="content-header-title">Affichage complet des commandes</h2>
          </div>
...
<div class="card">
    <div class="card-header">
        <h4 id="basic-forms" class="card-title">Toutes les commandes</h4>
...
if (isset($_POST['modifier'])){
  ...
  echo $_POST['NoC_ini'];
  ?>
<meta http-equiv="Refresh" content="0;URL=affichercategorie.php">
<?php
}
?>
