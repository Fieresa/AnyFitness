...
include "../core/commandesc.php";
 ...
 {               $commandesc1=new commandesc();
  $sql="select * from commandes c inner join panier on id=panier where numcmd like '%".$_POST["query"]."%' or c.client like '%".$_POST["query"]."%' or produit like '%".$_POST["query"]."%' or prixu like '%".$_POST["query"]."%' or quantite like '%".$_POST["query"]."%' or c.date like '%".$_POST["query"]."%' or c.heure like '%".$_POST["query"]."%' or panier like '%".$_POST["query"]."%' order by produit" ;
