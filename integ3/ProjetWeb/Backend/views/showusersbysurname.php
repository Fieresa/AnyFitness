        ...
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          <li class=" nav-item"><a href="index.html"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Users</span></a>
            <ul class="menu-content">
			  ...
			  <li class="active"><a href="showusers.php" data-i18n="nav.dash.main" class="menu-item">Show</a>
              </li>
...
$user1C=new userC();
$listeUsers=$user1C->afficherUsersBYSURNAME();
...
foreach($listeUsers as $row){
	...
	<input class="button" type="submit" name="supprimer" value="Delete">
