...
$listecommandes=$commandesc1->affichercommandesp();
$prixcommandes=$commandesc1->prixtotal();
?>
<!DOCTYPE HTML>
<html>
	<head>
...
<table>
<form method="POST" action="ajoutcommandes1.php">
...
<form method="POST" action="payer.php">
	...
	<br>
	<br>
	<form method="POST" action="hiscommandes.php">
	<input type="submit" name="Historique des commandes" value="Historique des commandes">
	</form>
	<br>
	<br>
	<form method="POST" action="recherchercommandes1.php">
