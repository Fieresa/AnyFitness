        ...
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          <li class=" nav-item"><a href="index.html"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Users</span></a>
            <ul class="menu-content">
              <li class="active"><a href="createuser.php" data-i18n="nav.dash.main" class="menu-item">Create</a>
              </li>
		  ...
		  <li class="nav-item"><a href="index.html"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Categories</span></a>
            <ul class="menu-content">
              <li  class="nav-item"><a href="create.php" data-i18n="nav.dash.main" class="menu-item">Create</a>
              </li>
          ...
          <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-xs-12">
            <div class="breadcrumb-wrapper col-xs-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="showusers.php">Users</a>
                </li>
...
<tr>
<td>Userid</td>
<td><input type="number" id="email" min="1" max="999999999999999" class="form-control" placeholder="UserId" name="userid" required></td>
</tr>
<tr>
<td>Nom</td>
<td><input type="text" id="fname" maxlength="15" class="form-control" placeholder="Firstname" name="prenom" required></td>
</tr>
<tr>
<td>Prenom</td>
<td><input type="text" id="lname" maxlength="15" class="form-control" placeholder="Lastname" name="nom" required></td>
</tr>
<tr>
<td>Email</td>
...
<tr>
<td></td>
<td><input class="button" type="submit" name="ajouter" value="Add"></td>
</tr>
</table>
</form>
...
<!-- Reflow end -->
    ...
    <footer class="footer footer-static footer-light navbar-border">
      <p class="clearfix text-muted text-sm-center mb-0 px-2"><span class="float-md-left d-xs-block d-md-inline-block">Copyright  &copy; 2017 <a href="https://twitter.com/fieresaesports" target="_blank" class="text-bold-800 grey darken-2">Sidkom Firas </a>, All rights reserved. </span></p>
    </footer>
