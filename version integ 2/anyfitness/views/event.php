...
$user=new User(0,$_POST['nom_client'],$_POST['prenom_client'],$conn);
$u=$user->Logedin($conn,$_POST['nom_client'],$_POST['prenom_client']);


if (!empty($_POST) && !empty($_POST['nom_client']) && !empty($_POST['prenom_client'])){
