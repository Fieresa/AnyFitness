...
$listecommandes=$commandesc1->afficherhiscommandes();
?>
<!DOCTYPE HTML>
<html>
	<head>
	...
	<div id="page">
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides" style="height: 1000px;">
			   	<li style="background-image: url(images/img_bg_2.jpg); height: 1000px;">
			   			...
			   			<div class="row">
				   			<div class="col-md-6 col-sm-12 col-md-offset-3 slider-text">
				   				<div class="slider-text-inner text-center">
				   					...
				   					<h1 style="position: relative; top: 100px;">Historique des commandes</h1>
				   					<table border="1" width="100%" id="tablepanier" style="position: relative; top: 100px;">
<tr>
<td>numcmd</td>
<td>produit</td>
<td>prix</td>
...
foreach($listecommandes as $row){
	...
	<td><a href="modifiercommandesp.php?numcmd=<?PHP echo $row['numcmd']; ?>">
	Modifier</a></td>
	</tr>
	<?PHP
}
