        ...
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          <li class=" nav-item"><a href="ajoutbackreservation.php"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Reservations</span></a>
            <ul class="menu-content">
              ...
              <li><a href="afficherbackreservation.php" data-i18n="nav.dash.main" class="menu-item">Display/Edit</a>
              </li>
			  <li><a href="rechercherReservation.php" data-i18n="nav.dash.main" class="menu-item">Search</a>
              </li>
            </ul>
          </li>
		  <li class=" nav-item"><a href="ajoutbackcour.php"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Cours</span></a>
            <ul class="menu-content">
              <li><a href="ajoutbackcour.php" data-i18n="nav.dash.main" class="menu-item">Add</a>
              </li>
              <li><a href="afficherbackcour.php" data-i18n="nav.dash.main" class="menu-item">Display/Edit</a>
              </li>
			...
			<li class="active"><a href="ajoutbackcoach.php"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Coachs</span></a>
            <ul class="menu-content">
              <li><a href="ajoutbackcoach.php" data-i18n="nav.dash.main" class="menu-item">Add</a>
              </li>
              <li><a href="afficherbackcoach.php" data-i18n="nav.dash.main" class="menu-item">Display/Edit</a>
              </li>
