...
if (isset($_POST['numcmd'])){
	$commandesc=new commandesc();
	    $result=$commandesc->modifierqt1($_POST['quantitee']-$_POST['quantite'],$_POST['produit']);
    $result=$commandesc->recuperercommandes($_POST['numcmd']);
...
foreach($result1 as $row){
	...
	$commandes=new commandes($_POST['numcmd'],$_SESSION['userid'],$id,0,$_POST['quantitee'],date("y/m/d"),date("H:i:s"),1);
	$commandesc->modifiercommandes($commandes,$_POST['numcmd']);
	?>
<?php header("Location: panier.php"); ?>
<?php
}
?>
