      ...
      <div class="main-menu-content">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
		  ...
		  <li class="nav-item"><a href="index.html"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Categories</span></a>
            <ul class="menu-content">
              <li><a href="create.php" data-i18n="nav.dash.main" class="menu-item">Create</a>
              </li>
			  <li><a href="users.php" data-i18n="nav.dash.main" class="menu-item">Show</a>
              </li>
...
<tr>
<td>Userid</td>
<td><input type="number" name="userid" value="<?PHP echo $userid ?>" readonly></td>
</tr>
<tr>
<td>Role</td>
<td><input type="text" name="role" value="<?PHP echo $role ?>" required ></td>
</tr>
<tr>
<td></td>
