    ...
    <div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow">
      ...
      <div class="main-menu-content">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          <li class="active"><a href="ajoutbackreservation.php"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Reservations</span></a>
            <ul class="menu-content">
              <li><a href="ajoutbackreservation.php" data-i18n="nav.dash.main" class="menu-item">Add</a>
              </li>
              <li><a href="afficherbackreservation.php" data-i18n="nav.dash.main" class="menu-item">Display/Delete</a>
              </li>
...
// mysql select query
$query = "select Id_cour from cour";
...
if (isset($_POST['modifier'])){
	$reservation=new reservation($_POST['Id_reservation'],$_POST['Id_cour'],$_POST['Id_client']);
